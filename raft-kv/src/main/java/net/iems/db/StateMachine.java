...
import net.iems.constant.Command;
import net.iems.constant.CommandType;
...
import static net.iems.constant.CommandType.DELETE;
import static net.iems.constant.CommandType.PUT;
